...
async function robloxStalk(username) {
  try {
    ...
    const avatar = await axios.get(`https://thumbnails.roblox.com/v1/users/avatar-headshot?userIds=${userId}&size=420x420&format=Png&isCircular=false`);
    const friends = await axios.get(`https://friends.roblox.com/v1/users/${userId}/friends/count`);
